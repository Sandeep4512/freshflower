function  product(p){
  ...
  <div class="cardbody">
      ...
      <p>${p.des.substring(0,100)} .... <a href=show.html?id=${p.id} style="color: blue;margin-left: 10px;">read more</a>
      </p>
  </div>
</div> 
</a>`;
...
const productContainer=document.createElement('div');
      ...
      for(i=0;i<products.length;i++){
         ...
         cardHolder.innerHTML=product(products[i]);
